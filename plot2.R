...
# Plot 2 with x-axis dat$Time and y-axis dat$Global_active_power
par(mfrow = c(1, 1), mar = c(5, 5, 3, 2)) # set number of graphs and margins
plot(dat$Time, dat$Global_active_power,  type = "l", xlab = "", ylab = "Global Active Power (kilowatts)", lty = 1)

## Copy plot2 to a PNG file
dev.copy(png, file = "~/Coursera/plot/plot2.png", width=480,height=480)
